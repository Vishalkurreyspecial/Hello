...
from config import BOT_TOKEN, ADMIN_IDS, GROUP_ID, CHANNEL_USERNAME, ATTACK_COMMAND  # Import ATTACK_COMMAND
...
# Group and channel details from config
GROUP_ID = GROUP_ID
...
def handle_attack(message):  
    ...
    # Crafting the attack command using the template from config.py  
    full_command = ATTACK_COMMAND.format(target=target, port=port, time_duration=time_duration)  
